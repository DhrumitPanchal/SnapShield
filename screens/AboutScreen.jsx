  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.contentContainer}>
        <Text style={styles.heading}>Welcome to SnapShield App</Text>
        ...
        <Text style={styles.description}>Email: support@snapshield.com</Text>
        <Text style={styles.description}>Website: www.snapshield.com</Text>
      </ScrollView>
    </View>
  );
};
